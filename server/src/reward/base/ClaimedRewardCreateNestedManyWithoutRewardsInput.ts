...
@InputType()
class ClaimedRewardCreateNestedManyWithoutRewardsInput {
...
export { ClaimedRewardCreateNestedManyWithoutRewardsInput as ClaimedRewardCreateNestedManyWithoutRewardsInput };
