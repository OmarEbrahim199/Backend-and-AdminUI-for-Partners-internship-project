...
class RewardCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ClaimedRewardCreateNestedManyWithoutRewardsInput,
  })
  @ValidateNested()
  @Type(() => ClaimedRewardCreateNestedManyWithoutRewardsInput)
  @IsOptional()
  @Field(() => ClaimedRewardCreateNestedManyWithoutRewardsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => FavouriteRewardCreateNestedManyWithoutRewardsInput,
  })
  @ValidateNested()
  @Type(() => FavouriteRewardCreateNestedManyWithoutRewardsInput)
  @IsOptional()
  @Field(() => FavouriteRewardCreateNestedManyWithoutRewardsInput, {
    nullable: true,
  })
