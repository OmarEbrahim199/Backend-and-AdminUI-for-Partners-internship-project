...
@InputType()
class RewardCreateNestedManyWithoutOrganisationsInput {
...
export { RewardCreateNestedManyWithoutOrganisationsInput as RewardCreateNestedManyWithoutOrganisationsInput };
