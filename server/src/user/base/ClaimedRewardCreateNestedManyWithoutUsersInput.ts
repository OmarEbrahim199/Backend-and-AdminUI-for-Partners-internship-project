...
@InputType()
class ClaimedRewardCreateNestedManyWithoutUsersInput {
...
export { ClaimedRewardCreateNestedManyWithoutUsersInput as ClaimedRewardCreateNestedManyWithoutUsersInput };
