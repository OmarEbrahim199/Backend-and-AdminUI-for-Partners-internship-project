...
@ArgsType()
class UpdateClaimedRewardArgs {
  @Field(() => ClaimedRewardWhereUniqueInput, { nullable: false })
  where!: ClaimedRewardWhereUniqueInput;
  @Field(() => ClaimedRewardUpdateInput, { nullable: false })
  data!: ClaimedRewardUpdateInput;
}

export { UpdateClaimedRewardArgs as UpdateClaimedRewardArgs };
