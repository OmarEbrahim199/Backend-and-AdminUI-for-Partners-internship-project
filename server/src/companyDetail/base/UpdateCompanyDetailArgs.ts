...
@ArgsType()
class UpdateCompanyDetailArgs {
  @Field(() => CompanyDetailWhereUniqueInput, { nullable: false })
  where!: CompanyDetailWhereUniqueInput;
  @Field(() => CompanyDetailUpdateInput, { nullable: false })
  data!: CompanyDetailUpdateInput;
}

export { UpdateCompanyDetailArgs as UpdateCompanyDetailArgs };
