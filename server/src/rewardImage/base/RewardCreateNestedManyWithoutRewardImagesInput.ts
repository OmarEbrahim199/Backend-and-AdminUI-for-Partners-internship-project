...
@InputType()
class RewardCreateNestedManyWithoutRewardImagesInput {
...
export { RewardCreateNestedManyWithoutRewardImagesInput as RewardCreateNestedManyWithoutRewardImagesInput };
